    ...
    <>
      ...
      <div className='flex justify-center items-center relative'>
        ...
        <svg width='34.5%' height='34.5%' viewBox="0 0 134 169" fill="none" xmlns="http://www.w3.org/2000/svg"
          ...
          <g>
            <Interactable id='top' selected={selected} setSelected={setSelected}>
              ...
              stroke="url(#linear)" fill='white'/>
            </Interactable>

            <Interactable id='top-right' selected={selected} setSelected={setSelected}>
            ...
            <Interactable id='bottom-right' selected={selected} setSelected={setSelected}>
            ...
            <Interactable id='bottom' selected={selected} setSelected={setSelected}>
            ...
            <Interactable id='bottom-left' selected={selected} setSelected={setSelected}>
            ...
            <Interactable id='top-left' selected={selected} setSelected={setSelected}> 
            ...
            <Interactable id='middle' selected={selected} setSelected={setSelected}>
